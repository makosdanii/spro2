...
void loop()
{
  ...
  print_nextion((long)Kb * 1000); // Printing the value of Kb
  _delay_ms(100);

  Serial.print("page2.x3.val=");
  print_nextion((long)Kt * 1000); // Printing the value of Kt
  _delay_ms(100);

  Serial.print("page2.x4.val=");
  print_nextion((long)J * 1000); //Printing of moment of inertia
  _delay_ms(100);
...
void measure_torque() {
  ...
  for (int i = 0; i < steps; i++) {
    ...
    for (int j = 0; j < NO_DATA_POINTS; j++) {
      ...
      print_nextion((long)t * 1000);// Printing the value of Force
      
      Serial.print("page1.x1.val=");
      print_nextion((long)v * 1000); // Printing the value of Speed
